def format_data(a1, a2, a3, a4, a5, a6, a7, a8):
    # Format data according to the expected types in the SQL statement
    a4 = float(a4.replace('$', ''))
    a5 = float(a5.replace('$', ''))
    a6 = float(a6.replace('$', ''))  # Convert to float and remove commas
    a8 = a8.replace("'","")


    # Create the formatted SQL INSERT statement
    sql_insert = f"({a1}, {a2}, '{a3}', {a4}, {a5}, {a6}, '{a7}',  '{a8}'),"
